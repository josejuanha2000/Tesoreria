...
Public Class CR_Transferencia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FDC_Tesoreria.CR_Transferencia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Transferencia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Transferencia = New CR_Transferencia()
        rpt.Site = Me.Site
        Return rpt
    End Function
